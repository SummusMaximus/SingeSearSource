	...
	public function new(x:Float, y:Float, ?character:String = "bf", ?isPlayer:Bool = false)
	{
		...
		switch (curCharacter)
		{
			...
			case 'monster':
				...
				playAnim('idle');
			case 'singe':
				tex = Paths.getSparrowAtlas('singe_assets','shared',true);
				frames = tex;

				animation.addByPrefix('idle', "SingeIdle", 24, false);
				animation.addByPrefix('singUP', "SingeUp", 24, false);
				animation.addByPrefix('singDOWN', "SingeDown", 24, false);
				animation.addByPrefix('singLEFT', 'SingeLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'SingeRight', 24, false);
			...
			case 'singe-first':
				...
				animation.addByPrefix('idle', "SingeCalm", 24, false);
				animation.addByPrefix('singUP', "SingeUp", 24, false);
				animation.addByPrefix('singDOWN', "SingeDown", 24, false);
				animation.addByPrefix('singLEFT', 'SingeLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'SingeRight', 24, false);
				...
				playAnim('idle');
			case 'singe-wf':
				tex = Paths.getSparrowAtlas('singe_assets_wf','shared',true);
				frames = tex;
			...
			case 'singe-first-wf':
				...
				playAnim('idle');
			case 'sear':
				tex = Paths.getSparrowAtlas('sear_assets','shared',true);
				frames = tex;

				animation.addByPrefix('idle', "SearIdle", 24, false);
				animation.addByPrefix('singUP', "SearUp", 24, false);
				animation.addByPrefix('singDOWN', "SearDown", 24, false);
				animation.addByPrefix('singLEFT', 'SearLeft', 24, false);
				animation.addByPrefix('singRIGHT', 'SearRight', 24, false);

				loadOffsetFile(curCharacter);

				setGraphicSize(Std.int(width * 0.89));
				updateHitbox();

				playAnim('idle');
			case 'sear-wf':
				tex = Paths.getSparrowAtlas('sear_assets_wf','shared',true);
				frames = tex;
			...
			case 'bf':
				...
				flipX = true;
			case 'bf-wf':
				var tex = Paths.getSparrowAtlas('BOYFRIENDWF','shared',true);
				frames = tex;
